...
@class DDMedia, NSMutableArray, NSString;

@interface DDDroneHandler : NSObject <MWPhotoBrowserDelegate>
{
...
- (void).cxx_destruct;
- (void)downloadFiles:(id)arg1 files:(id)arg2;
- (void)photoBrowser:(id)arg1 repairVideoAtIndex:(unsigned long long)arg2;
...
- (void)deleteFiles:(id)arg1 photo:(id)arg2 thumb:(id)arg3;
