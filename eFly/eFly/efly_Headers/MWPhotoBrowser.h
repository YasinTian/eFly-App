...
@class DDGalleryEditTitle, DDGalleryMenu, MBProgressHUD, MPMoviePlayerViewController, MWGridViewController, NSArray, NSMutableArray, NSMutableSet, NSString, NSTimer, UIActivityIndicatorView, UIActivityViewController, UIBarButtonItem, UIColor, UIImage, UIScrollView, UIToolbar;
...
@interface MWPhotoBrowser : UIViewController <UIScrollViewDelegate, UIActionSheetDelegate>
{
    ...
    DDGalleryMenu *_galleryMenu;
    DDGalleryEditTitle *_galleryEditTitle;
...
@property(nonatomic) _Bool currentIsGrid; // @synthesize currentIsGrid=_currentIsGrid;
@property(nonatomic) unsigned long long currentGalleryType; // @synthesize currentGalleryType=_currentGalleryType;
...
- (void)editFileAciton;
- (void)shareFileAciton;
- (void)repairVideoAciton;
- (void)saveFileAciton;
- (void)deleteFileAciton;
- (void)rebuildToolBar;
- (void)updateCurrentVideoIcon;
...
- (void)loadEditMenu;
- (void)loadEditTitle;
- (struct CGRect)gridNormalFrame;
- (struct CGRect)gridEditFrame;
