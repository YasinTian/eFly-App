...
@interface TuSDKGPUImageFourInputFilter : GPUImageThreeInputFilter
{
...
- (_Bool)newFrameReadyAtTimeHookCmTime:(CDStruct_1b6d18a9)arg1 otherFrameTime:(CDStruct_1b6d18a9)arg2 atIndex:(long long)arg3;
