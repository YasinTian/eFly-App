...
@class DDTutorshipHandler, NSMutableArray, NSString;

@interface DDTutorshipManualViewController : UITableViewController <DDTutorshipHandlerDelegate, ReaderViewControllerDelegate>
{
