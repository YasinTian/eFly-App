...
#import "TuSDKCPGroupFilterTableViewInterface-Protocol.h"
...
@property(nonatomic) __weak id <TuSDKCPGroupFilterTableViewDelegate> delegate; // @synthesize delegate=_delegate;
