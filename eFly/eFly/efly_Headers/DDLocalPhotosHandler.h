...
@protocol DDLocalPhotosHandlerDelegate;

@interface DDLocalPhotosHandler : DDLocalHandler
{
    _Bool _inited;
    id <DDLocalPhotosHandlerDelegate> _delegate;
}

+ (id)sharedInstance;
@property(retain, nonatomic) id <DDLocalPhotosHandlerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
