...
@class NSArray, NSIndexPath, TuSDKFilterOption;
...
@property(retain, nonatomic) NSArray *cellItemDatas;
@property(retain, nonatomic) TuSDKFilterOption *lasOpt;
...
@property(nonatomic) __weak id <TuSDKCPStackFilterTableViewDelegate> delegate;
